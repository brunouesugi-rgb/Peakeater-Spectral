...
namespace {
// DSP configuration
int constexpr gAnalyzerSampleRateHz = 15;
...
void PeakAnalyzerComponent::resized() {
    ...
    auto const labelFont = juce::Font(static_cast<float>(fontSize));
    mInputLabel.setFont(labelFont);
    mOutputLabel.setFont(labelFont);
    mEatenLabel.setFont(labelFont);
...
void PeakAnalyzerComponent::updateLabels() {
